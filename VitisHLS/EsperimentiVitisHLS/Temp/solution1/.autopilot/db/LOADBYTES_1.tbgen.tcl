...
set C_modelName {LOADBYTES.1}
set C_modelType { int 64 }
set C_modelArgList {
	{ gmem int 8 regular {axi_master 0}  }
	{ bytes int 64 regular  }
	{ n int 4 regular  }
	{ idx int 5 regular  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ bytes sc_in sc_lv 64 signal 1 } 
	{ n sc_in sc_lv 4 signal 2 } 
	{ idx sc_in sc_lv 5 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bytes", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "bytes", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	bytes { ap_none {  { bytes in_data 0 64 } } }
