...
set C_modelArgList {
	...
	{ nsec int 64 unused {axi_slave 0}  }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "4", "5"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "173", "EstimateLatencyMax" : "413",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_crypto_aead_encrypt_1_fu_94", "Port" : "gmem", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_crypto_aead_encrypt_1_fu_94", "Parent" : "0", "Child" : ["2", "3"],
		...
		"Port" : [
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "IO",
				...
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_LOADBYTES_1_fu_418", "Port" : "gmem", "Inst_start_state" : "43", "Inst_end_state" : "44"}]},
			{"Name" : "c", "Type" : "None", "Direction" : "I"},
			{"Name" : "m", "Type" : "None", "Direction" : "I"},
			{"Name" : "ad", "Type" : "None", "Direction" : "I"},
			{"Name" : "npub", "Type" : "None", "Direction" : "I"},
			{"Name" : "k", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_crypto_aead_encrypt_1_fu_94.grp_LOADBYTES_1_fu_418", "Parent" : "1",
		"CDFG" : "LOADBYTES_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_crypto_aead_encrypt_1_fu_94.grp_ROUND_6_fu_436", "Parent" : "1",
		"CDFG" : "ROUND_6",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	axi_encrypt {
		...
		nsec {Type I LastRead -1 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "173", "Max" : "413"}
	, {"Name" : "Interval", "Min" : "174", "Max" : "414"}
]}
