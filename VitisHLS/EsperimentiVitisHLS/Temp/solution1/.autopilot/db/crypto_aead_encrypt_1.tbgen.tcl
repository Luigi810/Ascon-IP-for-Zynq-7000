set moduleName crypto_aead_encrypt_1
set isTopModule 0
...
set C_modelName {crypto_aead_encrypt.1}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "c","offset": { "type": "dynamic","port_name": "c","bundle": "control"},"direction": "WRITEONLY"},{"cName": "m","offset": { "type": "dynamic","port_name": "m","bundle": "control"},"direction": "READONLY"},{"cName": "ad","offset": { "type": "dynamic","port_name": "ad","bundle": "control"},"direction": "READONLY"},{"cName": "nsec","offset": { "type": "dynamic","port_name": "nsec","bundle": "control"},},{"cName": "npub","offset": { "type": "dynamic","port_name": "npub","bundle": "control"},"direction": "READONLY"},{"cName": "k","offset": { "type": "dynamic","port_name": "k","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "c", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "m", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "ad", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "npub", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ad sc_in sc_lv 64 signal 3 } 
	{ npub sc_in sc_lv 64 signal 4 } 
	{ k sc_in sc_lv 64 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ad", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "ad", "role": "default" }} , 
 	{ "name": "npub", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "npub", "role": "default" }} , 
 	{ "name": "k", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "k", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "crypto_aead_encrypt_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "171", "EstimateLatencyMax" : "411",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "IO",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_LOADBYTES_1_fu_418", "Port" : "gmem", "Inst_start_state" : "43", "Inst_end_state" : "44"}]},
			{"Name" : "c", "Type" : "None", "Direction" : "I"},
			{"Name" : "m", "Type" : "None", "Direction" : "I"},
			{"Name" : "ad", "Type" : "None", "Direction" : "I"},
			{"Name" : "npub", "Type" : "None", "Direction" : "I"},
			{"Name" : "k", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_LOADBYTES_1_fu_418", "Parent" : "0",
		"CDFG" : "LOADBYTES_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_22_1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "12", "FirstState" : "ap_ST_fsm_state10", "LastState" : ["ap_ST_fsm_state12"], "QuitState" : ["ap_ST_fsm_state10"], "PreState" : ["ap_ST_fsm_state9"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_ROUND_6_fu_436", "Parent" : "0",
		"CDFG" : "ROUND_6",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	crypto_aead_encrypt_1 {
		gmem {Type IO LastRead 77 FirstWrite -1}
		c {Type I LastRead 44 FirstWrite -1}
		m {Type I LastRead 35 FirstWrite -1}
		ad {Type I LastRead 17 FirstWrite -1}
		npub {Type I LastRead 4 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "171", "Max" : "411"}
	, {"Name" : "Interval", "Min" : "171", "Max" : "411"}
]}
...
set Spec2ImplPortList { 
	...
	ad { ap_none {  { ad in_data 0 64 } } }
	npub { ap_none {  { npub in_data 0 64 } } }
