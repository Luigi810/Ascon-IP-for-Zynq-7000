...
__attribute__((sdx_kernel("axi_encrypt", 0))) int axi_encrypt(uint8_t c[32],const uint8_t m[16],
...
__attribute__((sdx_kernel("axi_encrypt", 0))) int axi_encrypt(uint8_t c[32],const uint8_t m[16],
    const uint8_t ad[16],uint8_t nsec[16],
    const uint8_t npub[16],const uint8_t k[16]){
#line 27 "C:/Users/lguer/AppData/Roaming/Xilinx/Vitis/AsconOptimizedHLS/EsperimentiVitisHLS/Temp/solution1/csynth.tcl"
