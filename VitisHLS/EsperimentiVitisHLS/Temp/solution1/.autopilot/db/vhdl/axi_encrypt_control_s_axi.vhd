...
entity axi_encrypt_control_s_axi is
generic (
...
end entity axi_encrypt_control_s_axi;
...
architecture behave of axi_encrypt_control_s_axi is
    ...
    constant ADDR_M_DATA_1    : INTEGER := 16#28#;
    constant ADDR_M_CTRL      : INTEGER := 16#2c#;
    constant ADDR_AD_DATA_0   : INTEGER := 16#30#;
    constant ADDR_AD_DATA_1   : INTEGER := 16#34#;
    constant ADDR_AD_CTRL     : INTEGER := 16#38#;
    constant ADDR_NSEC_DATA_0 : INTEGER := 16#3c#;
    constant ADDR_NSEC_DATA_1 : INTEGER := 16#40#;
    constant ADDR_NSEC_CTRL   : INTEGER := 16#44#;
    constant ADDR_NPUB_DATA_0 : INTEGER := 16#48#;
    constant ADDR_NPUB_DATA_1 : INTEGER := 16#4c#;
    constant ADDR_NPUB_CTRL   : INTEGER := 16#50#;
    constant ADDR_K_DATA_0    : INTEGER := 16#54#;
    constant ADDR_K_DATA_1    : INTEGER := 16#58#;
    constant ADDR_K_CTRL      : INTEGER := 16#5c#;
