...
signed int axi_decrypt( char *, signed int *, signed int *, signed int *, signed int *, signed int *);
...
static  char aesl_internal__OC_str[14] = "result: %01x\n";
static  char aesl_internal__OC_str1[8] = "m=%02x\n";
...
signed int main(void) {
  static  unsigned long long aesl_llvm_cbe_m_count = 0;
   char llvm_cbe_m[4];    /* Address-exposed local */
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = getelementptr inbounds [4 x i8]* %%m, i64 0, i64 0, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_2_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = call i8* @memset(i8* %%1, i32 0, i64 4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_3_count);
  ( char *)memset(( char *)llvm_cbe_tmp__1, 0u, 4ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",0u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = bitcast [4 x i32]* %%npub to i8*, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_11_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds [4 x i32]* %%nsec, i64 0, i64 0, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_17_count);
  llvm_cbe_tmp__11 = (signed int *)(&llvm_cbe_nsec[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = getelementptr inbounds [8 x i32]* %%c, i64 0, i64 0, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_18_count);
  llvm_cbe_tmp__12 = (signed int *)(&llvm_cbe_c[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 8
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = getelementptr inbounds [4 x i32]* %%ad, i64 0, i64 0, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_19_count);
  llvm_cbe_tmp__13 = (signed int *)(&llvm_cbe_ad[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = getelementptr inbounds [4 x i32]* %%npub, i64 0, i64 0, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_20_count);
  llvm_cbe_tmp__14 = (signed int *)(&llvm_cbe_npub[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = getelementptr inbounds [4 x i32]* %%k, i64 0, i64 0, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_21_count);
  llvm_cbe_tmp__15 = (signed int *)(&llvm_cbe_k[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = call i32 @axi_decrypt(i8* %%1, i32* %%11, i32* %%12, i32* %%13, i32* %%14, i32* %%15) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_22_count);
  llvm_cbe_tmp__16 = (unsigned int )axi_decrypt(( char *)llvm_cbe_tmp__1, (signed int *)llvm_cbe_tmp__11, (signed int *)llvm_cbe_tmp__12, (signed int *)llvm_cbe_tmp__13, (signed int *)llvm_cbe_tmp__14, (signed int *)llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__16);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%16) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_23_count);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )0ull) < 4)) fprintf(stderr, "%s:%d: warning: Read access out of array 'm' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = load i8* %%1, align 1, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_24_count);
  llvm_cbe_tmp__18 = (unsigned char )*llvm_cbe_tmp__1;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = zext i8 %%18 to i32, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_25_count);
  llvm_cbe_tmp__19 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_tmp__18&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @aesl_internal_.str1, i64 0, i64 0), i32 %%19) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_26_count);
