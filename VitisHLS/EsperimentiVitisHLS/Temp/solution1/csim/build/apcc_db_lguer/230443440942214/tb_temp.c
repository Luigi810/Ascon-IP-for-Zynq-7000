...
static  char aesl_internal_main_OC_m[16] = { ((unsigned char )18), ((unsigned char )52), ((unsigned char )86), ((unsigned char )120), ((unsigned char )-102), ((unsigned char )-68), ((unsigned char )-34), ((unsigned char )-16), ((unsigned char )15), ((unsigned char )-19), ((unsigned char )-53), ((unsigned char )-87), ((unsigned char )-121), ((unsigned char )101), ((unsigned char )67), ((unsigned char )33) };
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = call i8* @memcpy(i8* %%1, i8* getelementptr inbounds ([16 x i8]* @aesl_internal_main.m, i64 0, i64 0), i64 16 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_3_count);
  ( char *)memcpy(( char *)llvm_cbe_tmp__1, ( char *)((&aesl_internal_main_OC_m[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 16
#endif
])), 16ull);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = call i32 @axi_decrypt(i8* %%1, i8* %%5, i8* %%11, i8* %%3, i8* %%7, i8* %%9) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_18_count);
  llvm_cbe_tmp__12 = (unsigned int )axi_decrypt(( char *)llvm_cbe_tmp__1, ( char *)llvm_cbe_tmp__5, ( char *)llvm_cbe_tmp__11, ( char *)llvm_cbe_tmp__3, ( char *)llvm_cbe_tmp__7, ( char *)llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__12);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%12) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_19_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = load i8* %%1, align 16, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_20_count);
  llvm_cbe_tmp__14 = (unsigned char )*llvm_cbe_tmp__1;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
...
printf("\n = 0x%X\n", llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @aesl_internal_.str1, i64 0, i64 0), i32 %%15) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_22_count);
