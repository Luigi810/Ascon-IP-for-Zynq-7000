...
signed int axi_decrypt(signed int *, signed int *, signed int *, signed int *, signed int *, signed int *);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = call i32 @axi_decrypt(i32* %%11, i32* %%12, i32* %%13, i32* %%14, i32* %%15, i32* %%16) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_23_count);
  llvm_cbe_tmp__17 = (unsigned int )axi_decrypt((signed int *)llvm_cbe_tmp__11, (signed int *)llvm_cbe_tmp__12, (signed int *)llvm_cbe_tmp__13, (signed int *)llvm_cbe_tmp__14, (signed int *)llvm_cbe_tmp__15, (signed int *)llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__17);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%17) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_24_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = load i32* %%11, align 16, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_25_count);
  llvm_cbe_tmp__19 = (unsigned int )*llvm_cbe_tmp__11;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
