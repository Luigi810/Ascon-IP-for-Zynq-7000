...
int axi_decrypt(u128 m, u128 nsec,
	...
	u64_to_u8_array(m.array[0], &m_u8[0]);	//output
	u64_to_u8_array(m.array[1], &m_u8[8]);

	u64_to_u8_array(nsec.array[0], &nsec_u8[0]);
	u64_to_u8_array(nsec.array[1], &nsec_u8[8]);

	u64_to_u8_array(c.array[0], &c_u8[0]);
	u64_to_u8_array(c.array[1], &c_u8[8]);
	u64_to_u8_array(c.array[2], &c_u8[16]);
	u64_to_u8_array(c.array[3], &c_u8[24]);

	u64_to_u8_array(ad.array[0], &ad_u8[0]);
	u64_to_u8_array(ad.array[1], &ad_u8[8]);

	u64_to_u8_array(npub.array[0], &npub_u8[0]);
	u64_to_u8_array(npub.array[1], &npub_u8[8]);

	u64_to_u8_array(k.array[0], &k_u8[0]);
	u64_to_u8_array(k.array[1], &k_u8[8]);
...
int axi_encrypt(u256 c,const u128 m,
	...
	u64_to_u8_array(c.array[0], &c_u8[0]);	//output
	u64_to_u8_array(c.array[1], &c_u8[8]);
	u64_to_u8_array(c.array[2], &c_u8[16]);
	u64_to_u8_array(c.array[3], &c_u8[24]);

	u64_to_u8_array(m.array[0], &m_u8[0]);
	u64_to_u8_array(m.array[1], &m_u8[8]);
